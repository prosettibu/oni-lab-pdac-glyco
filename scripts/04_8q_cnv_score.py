...
scores = pd.read_csv('/lab/solexa_oni/patrick/updated_figures/infercnv_chr8q_scores.csv', index_col=0)
...
plt.tight_layout()
plt.savefig('/lab/solexa_oni/patrick/updated_figures/chr8q_violin_immune_vs_malignant.pdf', bbox_inches='tight')
plt.close('all')

print(f'Mann-Whitney p = {p:.3e}')
print(plot_df.groupby('Group')['chr8q_cnv_score'].describe())
print('Saved to /lab/solexa_oni/patrick/updated_figures/chr8q_violin_immune_vs_malignant.pdf')
...
plt.savefig('/lab/solexa_oni/patrick/updated_figures/chr8q_malignant_histogram.pdf', bbox_inches='tight')